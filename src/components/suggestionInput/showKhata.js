        ...
        function isInteger(value) {
          ...
          function checkKeys(){
            return props.Suggestions.filter(item => 
                item.Phone ?
                isInteger(e.target.value) ? item.Phone.toString().includes(e.target.value) 
                :
        ...
        const checker = () => {
            if(getValue.Phone != undefined ){
                ...
                props.handleInputChange(e);
                    if(getValue.Name){
                        if(props.simple == 'true'){
                            props.handleInputChange([props.Name , getValue.Phone ,getValue.id]);
                        }
                        return getValue.Phone+ ' , ' + getValue.Name
                    }
                    else{
